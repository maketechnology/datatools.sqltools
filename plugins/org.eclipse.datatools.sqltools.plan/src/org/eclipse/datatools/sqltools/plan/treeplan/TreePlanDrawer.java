...
/**
 * This is a tree-structure graphic plan drawer which implements
 * <code>drawPlan(IExecutionPlanDocument)</code> methods. We will convert the
 * <code>IExecutionPlanDocument</code> to our own model before drawing the plan
 *
 * @author Dafan Yang
 *
 */
public class TreePlanDrawer extends AbstractPlanDrawer
{
    ...
    private Figure createNodeFigure(TreePlanNodeComponent plan, int levelStart, int y, int level) {
        ...
        Figure node1 = new CompartmentFigure(plan.getName(), plan.getLabel1(), plan.isLabel1Highlighted(), plan.getLabel2(), plan.isLabel2Highlighted());
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.datatools.sqltools.plan.AbstractPlanDrawer#drawPlan(org.eclipse.datatools.
     * sqltools.plan.IExecutionPlanDocument)
     */
