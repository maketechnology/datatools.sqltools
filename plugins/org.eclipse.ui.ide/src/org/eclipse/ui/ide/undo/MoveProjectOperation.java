...
/**
 * A MoveProjectOperation represents an undoable operation for moving a project's content to a
 * different location. Clients may call the public API from a background thread.
 * <p>
...
public class MoveProjectOperation extends AbstractCopyOrMoveResourcesOperation {
     ...
     *
     * @see
     * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#updateResourceChangeDescriptionFactory(org
     * .eclipse.core.resources.mapping.IResourceChangeDescriptionFactory, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.ui.ide.undo.AbstractCopyOrMoveResourcesOperation#isDestinationPathValid(org.
     * eclipse.core.resources.IResource, int)
     */
     ...
     * 
     * @see
     * org.eclipse.ui.ide.undo.AbstractCopyOrMoveResourcesOperation#getProposedName(org.eclipse.core
     * .resources.IResource, int)
     */
     ...
     * (non-Javadoc)
     *
     * Checks that the specified project location is valid in addition to superclass checks.
     *
     ...
     *
     * @see org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#doExecute(org.eclipse.core.runtime.
     ...
     *
     * @see org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#doUndo(org.eclipse.core.runtime.
     * IProgressMonitor, org.eclipse.core.runtime.IAdaptable)
     */
     ...
     *
     * @see
     * org.eclipse.ui.ide.undo.AbstractWorkspaceOperation#computeUndoableStatus(org.eclipse.core.
