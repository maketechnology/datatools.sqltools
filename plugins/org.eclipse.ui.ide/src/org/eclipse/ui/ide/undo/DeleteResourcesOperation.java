...
/**
 * A DeleteResourcesOperation represents an undoable operation for deleting one or more resources in
...
public class DeleteResourcesOperation extends AbstractResourcesOperation {
     ...
     * @param deleteContent whether or not we are deleting content for projects
     */
    ...
    /*
     * Map execution status to deletion status. Provide an extra warning if project content is to be
     * deleted.
     */
    @Override
    ...
    /*
     * Overridden so that projects whose contents are not to be deleted will not be checked. A
     * better solution would be to add API to ReadOnlyStateChecker to specify whether project
     * children should be checked, but it is too late to do that now. See
     * https://bugs.eclipse.org/bugs/show_bug.cgi?id=180758
     */
    @Override
