...
/**
 * Sorter for viewers that display items of type <code>IResource</code>. The sorter supports two
 * sort criteria:
 * <p>
 * <code>NAME</code>: Folders are given order precedence, followed by files. Within these two groups
 * resources are ordered by name. All name comparisons are case-insensitive.
 * </p>
 * <p>
 * <code>TYPE</code>: Folders are given order precedence, followed by files. Within these two groups
 * resources are ordered by extension. All extension comparisons are case-insensitive.
 * </p>
 * <p>
...
public class ResourceSorter extends ViewerSorter {
    ...
    /**
     * Returns an integer value representing the relative sort priority of the given element based
     * on its class.
     * <p>
     * <ul>
    ...
    /**
     * Returns a number reflecting the collation order of the given resources based on their
     * resource names.
     *
    ...
    /**
     * Returns a number reflecting the collation order of the given resources based on their
     * respective file extensions. Resources with the same file extension will be collated based on
     * their names.
     *
     * @param resource1 the first resource element to be ordered
     * @param resource2 the second resource element to be ordered
     ...
     *
     * @param criteria the sort criterion: one of <code>ResourceSorter.NAME</code> or
