...
/**
 * This class provides information regarding the context structure and content of specified tar file
 * entry objects.
 *
 * @since 3.1
 */
public class TarLeveledStructureProvider implements ILeveledImportStructureProvider {
    ...
    /**
     * Creates a new container tar entry with the specified name, iff it has not already been
     * created. If the parent of the given element does not already exist it will be recursively
     * created as well.
     * 
