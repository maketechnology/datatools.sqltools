...
/**
 * Dispenses adapters for various core objects. Returns IWorkbenchAdapter adapters, used for
 * displaying, navigating, and populating menus for core objects.
 */
public class WorkbenchAdapterFactory implements IAdapterFactory {
     ...
     *
     * @param o the adaptable object being queried (usually an instance of <code>IAdaptable</code>)
     * @param adapterType the type of adapter to look up
     * @return a object castable to the given adapter type, or <code>null</code> if this adapter
     *         provider does not have an adapter of the given type for the given object
     */
     ...
     * <p>
     * This method is generally used by an adapter manager to discover which adapter types are
     * supported, in advance of dispatching any actual <code>getAdapter</code> requests.
     * </p>
     *
    ...
    /**
     * Returns an object which is an instance of IElementFactory associated with the given object.
     * Returns <code>null</code> if no such object can be found.
     */
    ...
    /**
     * Returns an object which is an instance of IPersistableElement associated with the given
    ...
    /**
     * Returns an object which is an instance of IWorkbenchAdapter associated with the given object.
     * Returns <code>null</code> if no such object can be found.
     */
