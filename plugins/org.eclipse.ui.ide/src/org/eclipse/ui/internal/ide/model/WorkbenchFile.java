...
public class WorkbenchFile extends WorkbenchResource {
    ...
    /**
     * Constant that is used as the key of a session property on IFile objects to cache the result
     * of doing a proper content type lookup. This will be set by the ContentTypeDecorator (if
     * enabled) and used instead of the "guessed" content type in {@link #getBaseImage(IResource)}.
     *
     * @since 3.4
     */
