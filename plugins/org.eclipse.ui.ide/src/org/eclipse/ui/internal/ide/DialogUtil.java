...
public class DialogUtil {
    ...
    /**
     * Open an error style dialog for PartInitException by including any extra information from the
     * nested CoreException if present.
     */
    ...
    /**
     * Return whether or not the font in the parent is the size of a regular font. Typically used to
     * know if a font is smaller than the High Contrast Font. This method is used to make layout
     * decisions based on screen space.
     *
     * @param parent The Composite whose Font will be queried.
