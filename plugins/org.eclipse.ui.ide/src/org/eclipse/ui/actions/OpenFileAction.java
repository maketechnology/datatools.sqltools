...
public class OpenFileAction extends OpenSystemEditorAction {
    ...
    /**
     * Creates a new action that will open editors on the then-selected file resources. Equivalent
     * to <code>OpenFileAction(page,null)</code>.
     *
    ...
    /**
     * Creates a new action that will open instances of the specified editor on the then-selected
     * file resources.
     *
     * @param page the workbench page in which to open the editor
     ...
     * @return <code>true</code> if the file is local, and <code>false</code> if it could not be
     *         made local for some reason
     */
