...
public class CopyResourceAction extends SelectionListenerAction implements
     ...
     * the user. This name will <b>not be verified by the caller, so it must be
     * valid and unique.
     * <p>
     ...
     * @return the new full path for the copy, or <code>null if the resource
     ...
     * selection dialog, or <code>null if there is no initial selection
     * @return The initial container; <code>null if none.
     */
     ...
     * @return The shell for parenting dialogs; never <code>null.
     */
    Shell getShell() {
    ...
    /**
     * The <code>CopyResourceAction implementation of this 
     * <code>ISelectionValidator method checks whether the given path
     ...
     *  <code>null if the operation should be abandoned
     */
    ...
    /**
     * Runs the operation created in <code>createOperaiton
     * 
    ...
    /**
     * The <code>CopyResourceAction implementation of this
     * <code>SelectionListenerAction method enables this action only if 
