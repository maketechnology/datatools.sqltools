...
/**
 * A {@link DelegatingStyledCellLabelProvider} is a {@link StyledCellLabelProvider} that delegates
 * requests for the styled string and the image to a
 * {@link DelegatingStyledCellLabelProvider.IStyledLabelProvider}.
 *
 * <p>
 * Existing label providers can be enhanced by implementing
 * {@link DelegatingStyledCellLabelProvider.IStyledLabelProvider} so they can be used in viewers
 * with styled labels.
 * </p>
 *
 * <p>
 * The {@link DelegatingStyledCellLabelProvider.IStyledLabelProvider} can optionally implement
 * {@link IColorProvider} and {@link IFontProvider} to provide foreground and background color and a
 * default font.
 * </p>
 *
 * @since 1.1
...
public class DelegatingStyledCellLabelProvider extends StyledCellLabelProvider {
     ...
     * <p>
     * The {@link DelegatingStyledCellLabelProvider.IStyledLabelProvider} can optionally implement
     * {@link IColorProvider} and {@link IFontProvider} to provide foreground and background color
     * and a default font.
     * </p>
     */
public static interface IStyledLabelProvider extends IBaseLabelProvider {
         ...
         * @return the image used to label the element, or <code>null</code> if there is no image
...
public DelegatingStyledCellLabelProvider(IStyledLabelProvider labelProvider) {
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.jface.viewers.StyledCellLabelProvider#update(org.eclipse.jface.viewers.
     * ViewerCell)
     */
