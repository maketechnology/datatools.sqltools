...
/*******************************************************************************
 * Copyright (c) 2009, 2015 IBM Corporation and others. All rights reserved. This program and the
 * accompanying materials are made available under the terms of the Eclipse Public License v1.0
 * which accompanies this distribution, and is available at
 * http://www.eclipse.org/legal/epl-v10.html
 *
 * Contributors: IBM Corporation - initial API and implementation rob.stryker@jboss.com - bug 243824
 * [CommonNavigator] lacks table / tree-table support
 *******************************************************************************/
...
import org.eclipse.ui.ide.DecoratingStyledCellLabelProvider;
/**
 * Decorating label provider with styled label support for the navigator.
 * <p>
 * If the wrapped label provider is a
 * {@link org.eclipse.jface.viewers.DelegatingStyledCellLabelProvider.IStyledLabelProvider} it will
 * use the styled label it provides.
 * </p>
 * <p>
 * The label provider listens to the built-in decoration colors (
 * {@link JFacePreferences#QUALIFIER_COLOR}, {@link JFacePreferences#COUNTER_COLOR} and
 * {@link JFacePreferences#DECORATIONS_COLOR}. If other colors are used, it is the responsibility of
 * the wrapped label provider to fire the refresh.
 * </p>
 */
public class NavigatorDecoratingLabelProvider extends DecoratingStyledCellLabelProvider implements IPropertyChangeListener, ILabelProvider, ITableLabelProvider {
    ...
    public void propertyChange(PropertyChangeEvent event) {
        ...
        if (property.equals(JFacePreferences.QUALIFIER_COLOR) || property.equals(JFacePreferences.COUNTER_COLOR) || property
                        .equals(JFacePreferences.DECORATIONS_COLOR) /*
                                                                     * || property.equals(
